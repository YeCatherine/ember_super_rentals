!function(){"use strict"
self.CACHE_BUSTER="1630509556016|0.7291773135211688",self.addEventListener("install",(function(e){return self.skipWaiting()})),self.addEventListener("activate",(function(e){return self.clients.claim()}))
var e=(e,t)=>caches.keys().then((n=>{n.forEach((n=>{0===n.indexOf(e)&&n!==t&&caches.delete(n)}))}))
const t="esw-asset-cache-1",n=["assets/images/teaching-tomster-756a14cc8225582bf530b5d0c624db4d.png","assets/super-rentals-8005033ca22c96ad7528908a4208e225.css","assets/super-rentals-2dce19110f386e3734f8188097313d15.js","assets/vendor-d41d8cd98f00b204e9800998ecf8427e.css","assets/vendor-0b94297eb54dd1357a2182e6720d15c4.js"].map((e=>new URL(e,self.location).toString()))
...
const a=[],i=[]
self.INDEX_FILE_HASH="5f7fa40d91cf23d05bd9db0d975f1f1b"
